...
def recs_to_string(event = None):
	...
	text_box1.insert("end-1c", recs_list[0][0])

	text_box2 = tk.Text(root, width = 80, height = 2)
	text_box2.grid(row = 3, column = 1, columnspan = 2)
	text_box2.insert("end-1c", recs_list[0][1])

	text_box3 = tk.Text(root, width = 80, height = 2)
	text_box3.grid(row = 4, column = 1, columnspan = 2)
	text_box3.insert("end-1c", recs_list[0][2])

	text_box4 = tk.Text(root, width = 80, height = 2)
	text_box4.grid(row = 5, column = 1, columnspan = 2)
	text_box4.insert("end-1c", recs_list[0][3])

	text_box5 = tk.Text(root, width = 80, height = 2)
	text_box5.grid(row = 6, column = 1, columnspan = 2)
	text_box5.insert("end-1c", recs_list[0][4])

	text_box6 = tk.Text(root, width = 80, height = 2)
	text_box6.grid(row = 7, column = 1, columnspan = 2)
	text_box6.insert("end-1c", recs_list[0][5])

	text_box7 = tk.Text(root, width = 80, height = 2)
	text_box7.grid(row = 8, column = 1, columnspan = 2)
	text_box7.insert("end-1c", recs_list[0][6])

	text_box8 = tk.Text(root, width = 80, height = 2)
	text_box8.grid(row = 9, column = 1, columnspan = 2)
	text_box8.insert("end-1c", recs_list[0][7])

	text_box9 = tk.Text(root, width = 80, height = 2)
	text_box9.grid(row = 10, column = 1, columnspan = 2)
	text_box9.insert("end-1c", recs_list[0][8])

	text_box10 = tk.Text(root, width = 80, height = 2)
	text_box10.grid(row = 11, column = 1, columnspan = 2)
	text_box10.insert("end-1c", recs_list[0][9])
